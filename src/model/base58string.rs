...
impl Base58String {
    fn from_bytes(bytes: Vec<u8>) -> Base58String {
        Base58String { bytes }
    }

    fn from_string(encoded: String) -> Base58String {
...
mod tests {
    ...
    fn test_base58string_from_string() {
        let base58string = Base58String::from_string(
            "7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2"
                .to_string()
        );

        assert_eq!(base58string.encoded(), "7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2");
        assert_eq!(base58string.encoded_with_prefix(), "base58:7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2")
    }
    ...
    fn test_eq_between_base58_strings() {
        let bytes = bs58::decode(
            "7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2"
        ).into_vec().expect("Failed to parse base58 string");
        let base58string1 = Base58String::from_bytes(bytes);

        let base58string2 = Base58String::from_string(
            "7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2"
                .to_string()
        );

        let base58string3 = Base58String::from_string(
            "8LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2"
                .to_string()
        );
    ...
    fn test_pretty_print() {
        ...
        assert_eq!("7LBopaBdBzQbgqrnwgmgCDhcSTb32MYhE96SnSHcqZC2", formatted_string)
    }
}